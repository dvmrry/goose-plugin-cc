...
Use these blocks selectively when composing Goose or GPT-5.4 prompts.
...
Use when Goose should act without asking routine questions.
...
Use when Goose might otherwise guess.
